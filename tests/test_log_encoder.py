...
class TestOTLPLogEncoder(unittest.TestCase):
    def test_encode(self):
        ...
        from snowflake.telemetry.serialize import SerializeToString

        self.assertEqual(SerializeToString(encode_logs(sdk_logs)), expected_encoding.SerializeToString())
