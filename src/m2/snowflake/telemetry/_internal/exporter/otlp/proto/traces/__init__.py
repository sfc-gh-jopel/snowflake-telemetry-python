...
from m2.snowflake.telemetry.opentelemetry.exporter.otlp.proto.common.trace_encoder import (
    encode_spans,
)
from m2.snowflake.telemetry.opentelemetry.proto.trace.v1.trace import TracesData
