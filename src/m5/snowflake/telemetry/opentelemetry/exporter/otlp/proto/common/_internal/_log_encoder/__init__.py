...
from m5.snowflake.telemetry.opentelemetry.proto.collector.logs.v1.logs_service import (
    ExportLogsServiceRequest,
)
from m5.snowflake.telemetry.opentelemetry.proto.logs.v1.logs import (
    ScopeLogs,
    ResourceLogs,
)
from m5.snowflake.telemetry.opentelemetry.proto.logs.v1.logs import LogRecord as PB2LogRecord

from opentelemetry.sdk._logs import LogData

from m5.snowflake.telemetry.serialize import SerializeToString

def encode_logs(batch: Sequence[LogData]) -> bytes:
    return SerializeToString(ExportLogsServiceRequest(resource_logs=_encode_resource_logs(batch))
)
