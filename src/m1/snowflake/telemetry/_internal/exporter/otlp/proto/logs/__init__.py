...
from m1.snowflake.telemetry.opentelemetry.exporter.otlp.proto.common._log_encoder import (
    encode_logs,
)
from m1.snowflake.telemetry.opentelemetry.proto.logs.v1.logs import LogsData
