...
from m6.snowflake.telemetry.opentelemetry.exporter.otlp.proto.common.metrics_encoder import (
    encode_metrics,
)
from m6.snowflake.telemetry.opentelemetry.proto.metrics.v1.metrics import MetricsData as PB2MetricsData
